...
export async function fetchSpells(rsql: string, page: number, size: number, auth: AuthContextProps): Promise<Page<Spell>> {
...
export async function updateSpell(spellId: string, dto: Partial<UpdateSpellDto>, auth: AuthContextProps): Promise<Spell> {
